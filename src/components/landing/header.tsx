  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-24 items-center">
        {/* Desktop Navigation */}
        <nav className="mr-4 hidden md:flex items-center gap-6 text-sm font-medium">
        ...
        <div className="flex w-full items-center justify-between md:hidden">
          ...
          <div className="w-10"> {/* Spacer to balance the hamburger menu icon */}
             <Button size="icon" className="bg-accent text-accent-foreground hover:bg-accent/90 invisible">
