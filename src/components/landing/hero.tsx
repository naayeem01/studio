...
export function Hero() {
  ...
  return (
    <>
        ...
        <div className="container grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10">
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="space-y-4 md:space-y-0 md:space-x-4">
              <Button className="w-full md:w-1/3 bg-accent text-accent-foreground hover:bg-accent/90" asChild>
                <a href="#pricing">Get Started</a>
              </Button>
              <Button variant="outline" className="w-full md:w-1/3" onClick={() => setIsDemoDialogOpen(true)}>
                Request a Demo
              </Button>
            </div>
          </div>
      ...
      <RequestDemoDialog open={isDemoDialogOpen} onOpenChange={setIsDemoDialogOpen} />
    </>
  );
}
